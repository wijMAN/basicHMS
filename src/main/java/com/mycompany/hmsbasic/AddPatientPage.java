...
//import javax.swing.JFrame;  // check costructor
...
// SAVE button action
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        // SAVE button action
        StringTokenizer st1=new StringTokenizer(jTextField2.getText());
...
//        if(name.length()!=0){
            int a=JOptionPane.showConfirmDialog(null,"PAKKA?","SAVE",JOptionPane.YES_NO_OPTION);
            if(a==0) 
            {
                ...
                try
                {
                    ...
                    st.executeUpdate("insert into patient (name,contact,age,gender,bloodGroup,address,medicalHistory) values"
                            +"('"+name+"','"+contact+"','"+age+"','"+gender+"','"+bloodGroup+"','"+address+"','"+medicalHistory+"')"); 
            
                    ResultSet rs=st.executeQuery("SELECT Last_insert_id()");
                    rs.next();
                    String patID=rs.getString(1);
                    JOptionPane.showMessageDialog(null, "Sucessfully Added\nNew Patient ID is "+patID+".");
...
//        }
        ...
        {
            JOptionPane.showMessageDialog(null, "Pehle patient ka naam & baki details bharo");
        }
